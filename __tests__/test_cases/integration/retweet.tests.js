...
describe('Given an authenticated user with a tweet', () => {
	...
	describe('When he retweets his own tweet', () => {
		...
		it('Save the retweet in the Tweets table', async () => {
		...
		it('Increments the retweetCount in the Tweets table', async () => {
		...
		it("Doesn't save anything in the Timelines table", async () => {
	...
	describe("When he retweets another user's tweet", () => {
		...
		it('Increments the retweetCount in the Tweets table', async () => {
			const { retweets } = await then.tweet_exists_in_the_TweetsTable(anotherTweet.id)
		...
		it('Saves tweet in the Timelines table', async () => {
			const tweets = await then.there_are_N_tweets_in_TimelinesTable(
				userA.username,
				2
			)
